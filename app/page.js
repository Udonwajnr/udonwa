...
// import img from './shot1.png'

export default function Home() {
  return (
    <Layout>
      <div className='flex justify-between py-[30px] pr[20px] h-full font-mono'>
        ...
        <div className='flex flex-wrap gap-2'>
          ...
          <div className='text-[#1A1A1A99] hover:text-black cursor-pointer flex items-center justify-center  px-10 py-1.5 border gap-x-5 rounded-3xl'>
            <input type='checkbox' className='cursor-pointer h-4 w-4'/>
            <label className='cursor-pointer hover:text-black text-[14px] font-bold'>NodeJs</label>
          </div>
        ...
        <div className='flex gap-x-4 align-bottom absolute bottom-0 '>
          ...
          <Link href={"/Umoh's_resume.pdf"} download className='flex items-center gap-x-3 hover:bg-[#f1f1f1] border py-2 px-4 border-[#cccccc] rounded-md'>
        ...
        <div className='w-8/12 border-[#cccccc] border-dotted  overflow-scroll flex flex-col gap-y-9 p-[40px]'>
            {/* works */}
