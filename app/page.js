  ...
  return (
    ...
    <Layout>
      <div className='flex justify-between py-[30px] pr[20px] lg:py-[0px] h-full font-mono lg:flex-col'>
        ...
        <div  className='relative border-r-2  max-w-2xl lg:max-w-none  pl-[40px] lg:p-[15px] border-[#cccccc] border-dotted lg:border-0'>
        ...
        <div className='flex flex-wrap gap-2 lg:hidden'>
          <div className='text-[#1A1A1A99] hover:text-black cursor-pointer flex items-center justify-center  py-1.5 border gap-x-5 rounded-3xl'>
        ...
        <div className='max-w-full border-[#cccccc] border-dotted  overflow-y-scroll lg:overflow-visible flex flex-col gap-y-9 p-[40px] lg:p-[15px]'>
            {/* works */}
                ...
                <div className=' h-full px-5 py-5 bg-[#f6f6f6] flex justify-between rounded-xl'>
                  ...
                  <div className='flex  items-center gap-x-5'>
                    <div className='flex items-center gap-x-3'>
                      ...
                      <Link href={"/"} className='hover:underline text-black text-[14px] lg:text-sm'>Preview</Link>
                    </div>
                    ...
                    <div className='flex items-center gap-x-3'>
                      ...
                      <Link href={"/"} className='hover:underline text-black text-[14px] lg:text-sm'>Vew Repo</Link>
                    </div>
